...
public class OfertaResource {
    ...
    private static final Logger LOGGER = Logger.getLogger(OfertaPersistence.class.getName()); //Encargado de registrar los mensajes para el sistema.

    /**
     * http://localhost:8080/traducciones-web/api/ofertas
     *
     * @param oferta correponde a la representación java del objeto json enviado
     * en el llamado.
     * @return Devuelve el objeto json de entrada que contiene el id creado por
     * la base de datos y el tipo del objeto java. Ejemplo: { "type":
     * "ofertaDTO", "id": 1, "nombre": "traduccion ingles frances", "cantidad":
     * "30", "descripcion": "Sirve para aplicar un descuento del 30%.",
    ...
    /**
     * GET para una oferta http://localhost:8080/traducciones-web/api/ofertas/1
     *
     * @param id corresponde al id de la oferta buscada.
     * @return La oferta encontrada. Ejemplo: { "type": "ofertaDTO", "id": 1,
     * "nombre": "traduccion inglesfrances", "cantidad": "30", "descripcion":
     * "Sirve para aplicar un descuento del 30% sobre un trabajo.", "codigo":
     * "AB32SD", "fechaVigencia": "25/09/2017"}
     * @throws BusinessLogicException
     *
     * En caso de no existir el id de la oferta buscada se retorna un 404 con el
     * mensaje.
     */
    @GET
    @Path("{id: \\d+}")
     ...
     * @throws BusinessLogicException
     *
     * En caso de no existir el nombre de la oferta buscada se retorna un 404
     * con el mensaje.
     */
    @GET
    @Path("{nombre: [a-zA-Z]+}")
    ...
    /**
     * GET para una oferta
     * http://localhost:8080/traducciones-web/api/ofertas/AB32SD
     *
     * @param codigoOferta corresponde al nombre de la oferta buscada.
     * @return La oferta encontrada. Ejemplo: { "type": "ofertaDTO", "id": 1,
     * "nombre": "traduccion inglesfrances", "cantidad": "30", "descripcion":
     * "Sirve para aplicar un descuento del 30% sobre un trabajo.", "codigo":
     * "AB32SD", "fechaVigencia": "25/09/2017"}
     * @throws BusinessLogicException
     * En caso de no existir el código de la oferta buscada se retorna un 404
     * con el mensaje.
     */
    @GET
    ...
    /**
     * PUT http://localhost:8080/traducciones-web/api/ofertas/1 Ejemplo json {
     * "id": 1, "nombre": "traduccion inglesfrances", "cantidadI": "30",
     * "cantActual": "29", "descripcion": "Sirve para aplicar un descuento del
     * 30% sobre un trabajo.", "codigo": "AB32SD", "fechaVigencia":
     * "25/09/2017"}
     *
     ...
     * @throws BusinessLogicException
     *
     * En caso de no existir el id de la oferta a actualizar. aje.
     */
    /* *  @PUT
     @Path("{id: \\d+}")
     ...
     */
     ...
     /**
     * DELETE para una oferta
     * http://localhost:8080/traducciones-web/api/ofertas/5
     *
     ...
     *
     * @param entityList corresponde a la lista de ofertas de tipo Entity que
