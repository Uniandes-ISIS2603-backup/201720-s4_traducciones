...
LOGGER = Logger.getLogger(OfertaPersistence.class.getName());
...
LOGGER.info("Creando un Oferta nuevo");
...
LOGGER.info("Creando un Oferta nuevo");
   ...
   /**
     * Actualiza un Oferta.
     *
     * @param entity: el Oferta que viene con los nuevos cambios. Por ejemplo
     * el codigo pudo cambiar. En ese caso, se haria uso del método update.
     * @return un Oferta con los cambios aplicados.
     */
    public OfertaEntity update(OfertaEntity entity) {
        LOGGER.log
(Level.INFO, "Actualizando Oferta con id={0}", entity.getId());
    ...
    */
    ...
    /**
     *
     * Borra un biblioteca de la base de datos recibiendo como argumento el id de la Oferta
     *
...
WHERE condition; en SQL.
         */
        return em.find
(OfertaEntity.class, id);
    }

    /**
     * Devuelve todas las Oferta de la base de datos.
     * @return una lista con todas las Oferta que encuentre en la base de
     * datos, "select u from OfertaEntity u" es como un "select * from
     * OfertaEntity;" - "SELECT * FROM table_codigo" en SQL.
     */
    public List<OfertaEntity> findAll() {
        LOGGER.info
("Consultando todas las Oferta");
        // Se crea un query para buscar todas las Oferta en la base de datos.
        TypedQuery 
query = em.createQuery("select u from OfertaEntity u", 
OfertaEntity.class);
